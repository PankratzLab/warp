...
workflow PairedFastqsToAlignedBam {
  ...
  String bwa_commandline = "bwa mem -K 100000000 -M -R $bash_readgroup_fmt -t 24 -Y $bash_ref_fasta $bash_fastq1 $bash_fastq2"
  ...
  scatter (PairedFastqs paired_fastqs in sample_and_paired_fastqs.flowcell_paired_fastqs) {
    ...
    call Alignment.PairedFastqsToBwaMemAndMba as PairedFastqsToBwaMemAndMba {
          input:
            read1 = read1,
            read2 = read2,
            readgroup_fmt = sample_and_paired_fastqs.readgroup_format,
